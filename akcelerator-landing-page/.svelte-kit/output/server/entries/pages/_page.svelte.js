...
const css$8 = {
  code: ".scroll-indicator.svelte-nm0hmi{animation:svelte-nm0hmi-bounceGentle 2s ease-in-out infinite}@keyframes svelte-nm0hmi-bounceGentle{0%,20%,50%,80%,100%{transform:translateY(0)}40%{transform:translateY(-8px)}60%{transform:translateY(-4px)}}.floating-particle.svelte-nm0hmi{animation:svelte-nm0hmi-float 4s ease-in-out infinite, svelte-nm0hmi-shimmer 6s ease-in-out infinite;box-shadow:0 0 8px rgba(176, 141, 87, 0.3);filter:drop-shadow(0 0 3px rgba(46, 93, 49, 0.2))}.particle-1.svelte-nm0hmi{animation-delay:0s, 0.5s}.particle-2.svelte-nm0hmi{animation-delay:0.8s, 1.2s}.particle-3.svelte-nm0hmi{animation-delay:1.5s, 2.1s}.particle-4.svelte-nm0hmi{animation-delay:2.2s, 0.3s}.particle-5.svelte-nm0hmi{animation-delay:1.1s, 3.2s}.particle-6.svelte-nm0hmi{animation-delay:2.8s, 1.8s}.particle-7.svelte-nm0hmi{animation-delay:0.4s, 2.5s}.particle-8.svelte-nm0hmi{animation-delay:1.9s, 0.7s}@keyframes svelte-nm0hmi-float{0%,100%{transform:translateY(0) translateX(0)}25%{transform:translateY(-8px) translateX(2px)}50%{transform:translateY(-15px) translateX(-1px)}75%{transform:translateY(-5px) translateX(3px)}}@keyframes svelte-nm0hmi-shimmer{0%,100%{opacity:var(--base-opacity, 0.6);box-shadow:0 0 8px rgba(176, 141, 87, 0.3)}50%{opacity:calc(var(--base-opacity, 0.6) + 0.2);box-shadow:0 0 12px rgba(176, 141, 87, 0.5), 0 0 20px rgba(46, 93, 49, 0.3)}}.czech-button-primary,.czech-button-secondary{opacity:1 !important;transform:translateY(0) !important}.czech-container.svelte-nm0hmi{padding:0 2rem}.czech-heading-xl.svelte-nm0hmi{margin-bottom:2rem}.czech-body-large.svelte-nm0hmi{margin-bottom:1.5rem}.flex.gap-4.svelte-nm0hmi{gap:1.5rem;margin-bottom:3rem}@media(max-width: 768px){.flex.svelte-nm0hmi{flex-direction:column;align-items:center;gap:1rem}.czech-container.svelte-nm0hmi{padding:0 1.5rem}.czech-heading-xl.svelte-nm0hmi{font-size:2rem;line-height:1.2;margin-bottom:1.5rem}.czech-body-large.svelte-nm0hmi{font-size:1.1rem;margin-bottom:1rem}.floating-particle.svelte-nm0hmi{opacity:0.6}}",
  map: null
};
const Hero = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<section class="parallax-container czech-flex-center"${add_attribute("this", heroContainer, 0)}> <div class="parallax-forest"${add_attribute("this", parallaxForest, 0)}></div>  <div class="floating-particle particle-1 svelte-nm0hmi" style="position: absolute; top: 20%; left: 10%; width: 5px; height: 5px; background: var(--czech-forest-light); border-radius: 50%; opacity: 0.8;"></div> <div class="floating-particle particle-2 svelte-nm0hmi" style="position: absolute; top: 30%; right: 15%; width: 4px; height: 4px; background: var(--copper-detail); border-radius: 50%; opacity: 0.7;"></div> <div class="floating-particle particle-3 svelte-nm0hmi" style="position: absolute; top: 60%; left: 20%; width: 6px; height: 6px; background: var(--moravian-earth); border-radius: 50%; opacity: 0.8;"></div> <div class="floating-particle particle-4 svelte-nm0hmi" style="position: absolute; top: 40%; right: 25%; width: 4px; height: 4px; background: var(--czech-forest); border-radius: 50%; opacity: 0.9;"></div> <div class="floating-particle particle-5 svelte-nm0hmi" style="position: absolute; top: 15%; right: 30%; width: 3px; height: 3px; background: var(--copper-light); border-radius: 50%; opacity: 0.6;"></div> <div class="floating-particle particle-6 svelte-nm0hmi" style="position: absolute; top: 70%; left: 15%; width: 4px; height: 4px; background: var(--czech-forest-light); border-radius: 50%; opacity: 0.7;"></div> <div class="floating-particle particle-7 svelte-nm0hmi" style="position: absolute; top: 50%; left: 5%; width: 5px; height: 5px; background: var(--copper-detail); border-radius: 50%; opacity: 0.8;"></div> <div class="floating-particle particle-8 svelte-nm0hmi" style="position: absolute; top: 35%; right: 5%; width: 3px; height: 3px; background: var(--moravian-earth); border-radius: 50%; opacity: 0.6;"></div>  <div class="czech-container czech-text-center relative z-10 svelte-nm0hmi"><h1 class="czech-heading-xl mb-6 svelte-nm0hmi"${add_attribute("this", mainHeading, 0)}>${escape(content[language].heading)}</h1> <p class="czech-body-large mb-4 max-w-2xl mx-auto svelte-nm0hmi"${add_attribute("this", subHeading, 0)}>${escape(content[language].subheading)}</p> <p class="czech-body mb-8 max-w-xl mx-auto opacity-80">${escape(content[language].description)}</p>  <div class="flex gap-4 justify-center flex-wrap svelte-nm0hmi"${add_attribute("this", ctaButtons, 0)}><button class="czech-button-primary"><span>${escape(content[language].ctaPrimary)}</span> <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M5 12h14M12 5l7 7-7 7"></path></svg></button> <button class="czech-button-secondary">${escape(content[language].ctaSecondary)}</button></div>  <div class="absolute bottom-8 left-1/2 transform -translate-x-1/2 czech-text-center"><p class="czech-body text-sm opacity-60 mb-2">${escape(content[language].scrollText)}</p> <div class="scroll-indicator svelte-nm0hmi" data-svelte-h="svelte-j9xrzi"><svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="var(--czech-forest)" stroke-width="2"><path d="M7 13l3 3 7-7M7 6l3 3 7-7"></path></svg></div></div></div> </section>`;
});
