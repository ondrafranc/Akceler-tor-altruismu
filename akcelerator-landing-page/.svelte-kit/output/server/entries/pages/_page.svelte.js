...
const css$2 = {
  code: ".feedback-trigger.svelte-a5alrl{position:fixed;bottom:100px;right:30px;background:linear-gradient(135deg, var(--czech-forest) 0%, var(--czech-forest-light) 100%);color:white;border:none;border-radius:50px;padding:12px 20px;font-weight:500;font-size:0.9rem;cursor:pointer;box-shadow:0 4px 20px rgba(46, 93, 49, 0.3);transition:all var(--timing-medium) var(--ease-gentle);z-index:50;display:flex;align-items:center;gap:8px;max-width:200px;opacity:1;visibility:visible}.feedback-trigger.svelte-a5alrl:hover{transform:translateY(-2px);box-shadow:0 6px 30px rgba(46, 93, 49, 0.4);background:linear-gradient(135deg, var(--czech-forest-light) 0%, var(--czech-forest) 100%)}.feedback-icon.svelte-a5alrl{font-size:1.2rem;flex-shrink:0}.feedback-text.svelte-a5alrl{white-space:nowrap}@media(max-width: 768px){.feedback-trigger.svelte-a5alrl{bottom:80px;right:15px;left:auto;padding:10px 16px;font-size:0.85rem;max-width:160px}.feedback-text.svelte-a5alrl{display:none}.feedback-icon.svelte-a5alrl{font-size:1.4rem}}@media(max-width: 480px){.feedback-trigger.svelte-a5alrl{bottom:70px;right:10px;border-radius:50%;padding:12px;width:48px;height:48px;justify-content:center}}.modal-overlay.svelte-a5alrl{position:fixed;top:0;left:0;right:0;bottom:0;background:rgba(0, 0, 0, 0.5);display:flex;align-items:center;justify-content:center;z-index:200;padding:20px;backdrop-filter:blur(4px);animation:svelte-a5alrl-fadeIn 0.3s ease-out}@keyframes svelte-a5alrl-fadeIn{from{opacity:0}to{opacity:1}}.modal-content.svelte-a5alrl{background:white;border-radius:16px;max-width:600px;width:100%;max-height:90vh;overflow-y:auto;box-shadow:0 20px 60px rgba(0, 0, 0, 0.3);animation:svelte-a5alrl-slideIn 0.3s ease-out}@keyframes svelte-a5alrl-slideIn{from{opacity:0;transform:translateY(-20px) scale(0.95)}to{opacity:1;transform:translateY(0) scale(1)}}.modal-header.svelte-a5alrl{display:flex;align-items:center;justify-content:space-between;padding:24px 24px 0;border-bottom:1px solid var(--subtle-border);margin-bottom:24px}.modal-title.svelte-a5alrl{font-size:1.5rem;color:var(--czech-forest);margin:0;font-weight:600}.modal-close.svelte-a5alrl{background:none;border:none;font-size:1.5rem;color:var(--text-secondary);cursor:pointer;padding:8px;border-radius:8px;transition:all var(--timing-quick) var(--ease-gentle)}.modal-close.svelte-a5alrl:hover{background:var(--bg-accent);color:var(--czech-forest)}.modal-body.svelte-a5alrl{padding:0 24px 24px}.modal-subtitle.svelte-a5alrl{color:var(--text-secondary);margin-bottom:24px;line-height:1.6}.feedback-form.svelte-a5alrl{display:flex;flex-direction:column;gap:20px}.form-group.svelte-a5alrl{display:flex;flex-direction:column;gap:8px}.form-label.svelte-a5alrl{font-weight:500;color:var(--text-primary);font-size:0.9rem}.optional.svelte-a5alrl{color:var(--text-muted);font-weight:400;font-size:0.8rem}.feedback-textarea.svelte-a5alrl{padding:12px;border:1px solid var(--subtle-border);border-radius:8px;font-family:inherit;font-size:0.9rem;line-height:1.5;resize:vertical;transition:border-color var(--timing-medium) var(--ease-gentle)}.feedback-textarea.svelte-a5alrl:focus{outline:none;border-color:var(--czech-forest);box-shadow:0 0 0 2px rgba(46, 93, 49, 0.1)}.char-counter.svelte-a5alrl{font-size:0.8rem;color:var(--text-muted);text-align:right}.emotion-select.svelte-a5alrl{padding:12px;border:1px solid var(--subtle-border);border-radius:8px;background:white;font-family:inherit;font-size:0.9rem;transition:border-color var(--timing-medium) var(--ease-gentle)}.emotion-select.svelte-a5alrl:focus{outline:none;border-color:var(--czech-forest);box-shadow:0 0 0 2px rgba(46, 93, 49, 0.1)}.star-rating-fieldset.svelte-a5alrl{border:none;padding:0;margin:0}.star-rating.svelte-a5alrl{display:flex;align-items:center;gap:4px;flex-wrap:wrap}.star.svelte-a5alrl{background:none;border:none;font-size:1.5rem;cursor:pointer;padding:4px;border-radius:4px;transition:all var(--timing-quick) var(--ease-gentle);opacity:0.3;color:#fbbf24}.star.svelte-a5alrl:hover,.star.filled.svelte-a5alrl{opacity:1;transform:scale(1.1)}.rating-label.svelte-a5alrl{font-size:0.85rem;color:var(--text-secondary);margin-left:8px;font-weight:500}.status-message.svelte-a5alrl{padding:12px;border-radius:8px;font-size:0.9rem;font-weight:500;text-align:center}.status-message.success.svelte-a5alrl{background:rgba(74, 124, 89, 0.1);color:var(--czech-forest);border:1px solid var(--czech-forest-light)}.status-message.error.svelte-a5alrl{background:rgba(220, 53, 69, 0.1);color:#dc3545;border:1px solid rgba(220, 53, 69, 0.3)}.submit-button.svelte-a5alrl{background:linear-gradient(135deg, var(--czech-forest) 0%, var(--czech-forest-light) 100%);color:white;border:none;padding:14px 24px;border-radius:8px;font-weight:500;font-size:0.95rem;cursor:pointer;transition:all var(--timing-medium) var(--ease-gentle);display:flex;align-items:center;justify-content:center;gap:8px}.submit-button.svelte-a5alrl:hover:not(:disabled){transform:translateY(-1px);box-shadow:0 4px 12px rgba(46, 93, 49, 0.4)}.submit-button.svelte-a5alrl:disabled{opacity:0.6;cursor:not-allowed;transform:none}.spinner.svelte-a5alrl{width:16px;height:16px;border:2px solid rgba(255, 255, 255, 0.3);border-radius:50%;border-top-color:white;animation:svelte-a5alrl-spin 1s ease-in-out infinite}@keyframes svelte-a5alrl-spin{to{transform:rotate(360deg)}}@media(max-width: 768px){.feedback-trigger.svelte-a5alrl{bottom:20px;right:20px;padding:10px 16px;font-size:0.8rem}.feedback-text.svelte-a5alrl{display:none}.modal-content.svelte-a5alrl{margin:10px;max-height:95vh}.modal-header.svelte-a5alrl,.modal-body.svelte-a5alrl{padding:16px}.modal-title.svelte-a5alrl{font-size:1.3rem}}@media(prefers-contrast: high){.modal-overlay.svelte-a5alrl{background:rgba(0, 0, 0, 0.8)}.modal-content.svelte-a5alrl{border:2px solid var(--czech-forest)}}@media(prefers-reduced-motion: reduce){.modal-overlay.svelte-a5alrl,.modal-content.svelte-a5alrl,.feedback-trigger.svelte-a5alrl,.star.svelte-a5alrl,.submit-button.svelte-a5alrl{animation:none;transition:none}}",
  map: null
};
const FeedbackModal = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `  <button class="feedback-trigger svelte-a5alrl"${add_attribute("aria-label", content[language].triggerLabel, 0)}${add_attribute("title", content[language].triggerTitle, 0)}><span class="feedback-icon svelte-a5alrl" data-svelte-h="svelte-1gjelm3">💬</span> <span class="feedback-text svelte-a5alrl">${escape(content[language].triggerText)}</span></button>  ${``}`;
});
