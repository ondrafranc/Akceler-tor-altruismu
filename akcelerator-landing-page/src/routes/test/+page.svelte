<script>
  ...
  const base = (PUBLIC_STREAMLIT_BASE_URL || '').replace(/\/$/, '');
  if (base) {
...
<section style="padding: 1rem;">
  ...
  <iframe data-test-id="streamlit-frame" src={previewUrl || 'about:blank'} style="width:100%;height:200px;border:1px solid #ddd;border-radius:8px;margin-bottom:12px;"></iframe>
